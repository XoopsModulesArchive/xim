...
define('_XIM_FOOTER_BAR_STYLE','Estilo da barra no rodapé');
...
define('_XIM_CHATWINDOWSTYLE_DEFAULT','Padrão');
...
define('_XIM_CHATDELETE_LOGS_DESC','Nunca apagar = 0. <br/>Defina um número para apagar as mensagens recebidas com mais de X minutos.<br/>É recomendado um numero maior que 60.');
?>
