...
(function($){
  jQuery.fn.buildContainers = function (options){
    return this.each (function (){
      ...
      if (container.attr("height")){
        container.find(".c:first").css("height",container.attr("height")-container.find(".n:first").outerHeight()-(container.find(".s:first").outerHeight()));
        container.find(".mbcontainercontent:first").css("height",container.attr("height")-container.find(".n:first").outerHeight()-(container.find(".s:first").outerHeight())-50);
      ...
      if (container.outerHeight()>nwh) {
        container.find(".c:first").css("height",(nwh-20)-container.find(".n:first").outerHeight()-(container.find(".s:first").outerHeight()));
        container.find(".mbcontainercontent:first").css("height",(nwh-20)-container.find(".n:first").outerHeight()-(container.find(".s:first").outerHeight())-50);
      }
  ...
  jQuery.fn.containerResize = function (){
    ...
    container.resizable({
      ...
      stop:function(){
        ...
        container.find(".c:first").css({height: elHeight});
        container.find(".mbcontainercontent:first").css({height: elHeight-50});
      ...
      this.dockIcon= $("<img src='"+container.attr("dckicon")+"' class='restoreContainer' width='"+opt.dockedIconDim+"'/>").appendTo(dockPlace)
        ...
        if (!$.browser.msie) {
          ...
          if(container.attr("collapsed")=="false"){
            ...
            container.find(".c:first").css("height",container.attr("h")-container.find(".n:first").outerHeight()-(container.find(".s:first").outerHeight()));
            container.find(".mbcontainercontent:first").css("height",container.attr("h")-container.find(".n:first").outerHeight()-(container.find(".s:first").outerHeight())-50);
          }
          else
  ...
  jQuery.fn.mb_resizeTo = function (h,w,anim){
    ...
    container.find(".c:first").animate({height: elHeight},anim);
    container.find(".mbcontainercontent:first").animate({height: elHeight-50},anim);
