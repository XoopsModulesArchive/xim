...
function createChatBox(containerId,chatBoxName){
	...
	var html = '<div id="MBchatbox_'+containerId+'" class="containerPlus draggable resizable {buttons:\'m,i,c\', icon:\'browser.png\', skin:\'default\',iconized:\'false\',dock:\'dock\', width:\'250\', height:\'300\',rememberMe:true, minWidth:\'250\', minHeight:\'300\'}" style="top:100px;left:100px">';
	var content ='<div class="no"><div class="ne"><div class="n">'+chatBoxName+'</div></div><div class="o"><div class="e"><div class="c"><div class="mbcontainercontent"></div><div style="position:relative; bottom:0px;"><textarea class="chatboxtextarea" onkeydown="javascript:return checkChatBoxInputKey(event,this,\''+containerId+'\');"></textarea></div></div></div></div><div><div class="so"><div class="se"><div class="s"></div></div></div></div></div>';
